...
from ssh_cert_service.version import version
...
def create_app(config=None) -> Flask:
    ...
    ################################################################
    # load defaults
    from ssh_cert_service import settings

    load_settings(app, env_prefix="SSH_CERT_SERVICE_", defaults=settings, config=config)
    ...
    from ssh_cert_service.views import api_v1, home
